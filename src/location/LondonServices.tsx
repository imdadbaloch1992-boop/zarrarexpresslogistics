...
const services = [
  {
    ...
    desc: "Urgent deliveries completed within hours across all London areas.",
  },
  {
    icon: <FaTruck size={35} />,
    title: "Next Day Delivery",
    desc: "Reliable next-day parcel delivery for businesses and individuals.",
  },
  {
    icon: <FaLock size={35} />,
    title: "Secure Handling",
    desc: "Every parcel is handled with maximum safety and tracking support.",
  },
  {
    icon: <FaClock size={35} />,
    title: "24/7 Availability",
    desc: "Courier services available anytime across London.",
  },
 {
  icon: <FaMapMarkedAlt size={35} />,
  title: "All London Coverage",
  desc: "Serving Westminster, Canary Wharf, Stratford & Greenwich.",
},
];
...
const features = [
  ...
  "Affordable pricing across London",
  "Business & personal courier solutions",
...
const LondonServices = () => {
  ...
  return (
    <>
      {/* SEO */}
      <Helmet>
        <title>London Courier Services | Same Day & Secure Delivery</title>
        <meta
          name="description"
          content="Professional courier services in London. Same day delivery, secure parcel handling, and full London coverage for fast and reliable shipping."
        />
      </Helmet>
      ...
      <Box className="bg-gradient-to-b from-gray-50 to-white min-h-screen mt-8 py-14 px-4 md:px-10">
        ...
        >
          ...
          >
            Reliable London Courier Services
          </Typography>

          <Typography className="text-gray-600 text-lg leading-relaxed">
            Fast, secure and same-day delivery solutions across London. Built for
            businesses and individuals who demand speed, reliability and trust.
          </Typography>
        </div>

        {/* Illustration */}
       {/* Illustration with single van sliding from right */}
<motion.div
...
>
  ...
  />
        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 mb-20">
          {services.map((service, index) => (
            <Card
              ...
              shadow-md transition-all duration-700 delay-${index * 100} group bg-white
        ...
        >
          ...
          >
            Why Choose Our London Courier Service?
          </Typography>
        ...
        <Typography className="text-center text-gray-500 mt-14 text-sm">
          Trusted courier partner in London — delivering speed, security & reliability.
        </Typography>
      </Box>
    </>
  );
